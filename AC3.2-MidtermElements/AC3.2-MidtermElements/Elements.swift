...
class Element {
    ...
    convenience init?(dictionary: [String: Any]) {
        ...
        //What if an elment has a melting or boiling point at 0? I don't think that is possible
        let castedMelting = dictionary["melting_c"] as? Int ??  0
        let castedBoiling = dictionary["boiling_c"] as? Int ??  0
